...
const faqs: { q: string; a: string }[] = [
  {
    ...
    a: "รับหล่อเหล็กหล่อสีเทา (FC150–FC300), เหล็กหล่อเหนียว (FCD45–FCD70), เหล็กกล้าหล่อ (S45C, S50C, SCMn, 4140, 4340), เหล็กทนสึก (Cr28, Ni-Hard, ASTM A532 Class A) และเหล็กทนความร้อน หมายเหตุ: ไม่รับหล่อทองเหลือง ทองแดง หรือทองคำ",
  },
  {
  ...
  },
  {
    ...
    a: "ดำเนินงานโดย บริษัท ซัคเซสเน็ทเวิร์ค จำกัด (Success Network Co., Ltd.) โรงหล่อเหล็กและงานหลอมโลหะประสบการณ์กว่า 20 ปี ที่อยู่ 307/288 หมู่ที่ 11 ต.บางพลีใหญ่ อ.บางพลี จ.สมุทรปราการ 10540",
  },
];
