...
const copy = {
  th: {
    ...
    switchLabel: "EN",
    hero: [
      ["ครบวงจร", "โรงหล่อเหล็ก รับจ้างผลิต", "เหล็กหล่อ, เหล็กหล่อเหนียว, เหล็กเหนียว,\nเหล็กทนสึก, เหล็กทนความร้อน"],
    ...
    welcome: [
      ...
      "ขอใบเสนอราคา ส่งรูปชิ้นงาน แบบ Drawing ขนาด วัสดุ จำนวน และรายละเอียดงานกลึง ผ่าน LINE @SCNW หรือโทร 098-636-2356 และ 06-3989-1165 ทีมงานประเมินและเสนอราคาให้ภายในเวลาทำการ (หมายเหตุ ไม่รับหล่อทองเหลือง ทองแดง หรือทองคำ)",
  ...
  en: {
    ...
    welcome: [
      ...
      "Request a quote: send a photo, drawing, dimensions, material, quantity and machining details via LINE @SCNW or call 098-636-2356 and 06-3989-1165. We review and quote within business hours. (Note: brass, copper and gold casting are not accepted.)",
